...
If you have questions about how to use this component, please open a [GitHub Issue](https://github.com/<%= config['github.username'] %>/<%= config['github.reponame'] %>/issues).

If you find a bug in the source code or a mistake in the documentation, you can help us by
submitting an issue to our [GitHub Issue](https://github.com/<%= config['github.username'] %>/<%= config['github.reponame'] %>/issues). Even better you can submit a Pull Request
with a fix.
...
* Search [Pull Requests](https://github.com/<%= config['github.username'] %>/<%= config['github.reponame'] %>/pulls) for an open or closed Pull Request
...
* In GitHub, send a pull request to `<%= config['github.reponame'] %>:master`.
...
---
adapted from https://github.com/angular/angular.js/blob/master/CONTRIBUTING.md#coc
